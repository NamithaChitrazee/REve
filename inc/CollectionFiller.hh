...
namespace mu2e{
    ...
    public:
        ...
        struct Config{
            ...
            fhicl::Atom<bool> addCrvHits{Name("addCrvHits"), Comment("set to add crv hits"),false}; // Corresponds to CrvRecoPulses
        ...
        bool addHits_, addCrvHits_, addCrvClusters_, addTimeClusters_, addTrkHits_, addCaloDigis_, 
