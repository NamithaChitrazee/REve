...
namespace mu2e{
    ...
    public:
        ...
        struct Config{
            ...
            fhicl::Atom<bool> shiftTracker{Name("shiftTracker"), Comment("shift tracker for VST results"),false};
            fhicl::Atom<bool> useAlignedTracker{Name("useAlignedTracker"), Comment("set to use aligned tracker geometry (proditions) in 2D station view; false uses nominal geometry (GeomHandle)"),false};
        ...
        // --- Boolean Control Flags (Copied from FHiCL Config) ---
         bool addHits_, addBkgClusters_, addCrvRecoPulse_, addCrvClusters_, addCrvTrack_, addTimeClusters_, addTrkHits_, addCaloDigis_,
           ...
           addSurfSteps_, addSimParts_, addTrackerHist_, addCaloHist_, shiftTracker_, useAlignedTracker_, FillAll_;
