  ...
  struct DrawOptions{
    ...
    class MainWindow  : public REX::REveElement {
        ...
        public :
            ...
            void showEvents(REX::REveManager *eveMng,  REX::REveScene* &eventScene, bool firstLoop,  bool firstLoopCalo, DataCollections &data, DrawOptions drawOpts, std::vector<int> particleIds, bool strawdisplay, GeomOptions geomOpts, KinKalOptions KKOpts, int run = 0, int subRun = 0, int event = 0);
